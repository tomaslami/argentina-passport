...
export function InvestmentsHero() {
  ...
  return (
    <section className="relative flex min-h-[677px] items-end overflow-hidden bg-navy-900 pb-24">
      {/* Watermark — 408px, UltraLight, centered */}
      <motion.span
        aria-hidden
        className="pointer-events-none absolute left-1/2 top-[160px] -translate-x-1/2 select-none whitespace-nowrap text-[25.5rem] font-extralight leading-none text-cream-50 opacity-5 uppercase"
